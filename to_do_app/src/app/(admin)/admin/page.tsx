...
export default function Dashboard() {
  ...
  const handleOpenAddModal = () => {
    setForm({ title: "", description: "", duedate: "", status: 0, userId: form.userId || "" });
        ...
        <div className="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-60">
          <div className="bg-gray-800 border border-white p-6 rounded shadow-lg max-w-lg w-full mx-4">
            ...
            <form className="flex flex-col space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                <label htmlFor="description-add" className="block mb-1 font-medium">
                  Description
                </label>
                <textarea
                  id="description-add"
        ...
        <div className="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-60">
          <div className="bg-gray-800 border border-white p-6 rounded shadow-lg max-w-lg w-full mx-4">
            ...
            <form className="flex flex-col space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                <label htmlFor="description-edit" className="block mb-1 font-medium">
                  Description
                </label>
                <textarea
                  id="description-edit"
              ...
              <div>
                <label htmlFor="duedate-edit" className="block mb-1 font-medium">
                  Due Date
                </label>
                <input
                  id="duedate-edit"
